        ...
        <Box sx={{ display: 'flex' }}>
            ...
            <Drawer variant="permanent" open={open}>
                ...
                <List>
                    ...
                    <ListItem disablePadding sx={{ display: 'block' }} onClick={() => { navigate('/set-value-master') }}>
                        <ListItemButton
                            sx={{
                                minHeight: 48,
                                justifyContent: open ? 'initial' : 'center',
                        ...
                        >
                            ...
                            <ListItemText primary="Set Value Master" sx={{ opacity: open ? 1 : 0, color: "rgba(0, 0, 0, 0.6)", fontSize: "0.875rem" }} />
                        </ListItemButton>
                    </ListItem>
